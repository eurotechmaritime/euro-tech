export const EN = {
  ...
  governing_board: {
    ...
    PM_DESIGNATION: "Principal – Euro Tech Maritime Academy",
    PM_CONTENT_1:
  ...
  awards: {
    ...
    DATA: [
      ...
      },
      {
        ...
        content:
          "Indian Seafarer’s Choice Awards 2015 Euro tech was awarded with The Best Institute for STCW courses South & east India Zone . It is titled as “Voice of the Indian Seafarer “The awards presented to the Crew Employers & Training Institutes will be decided, based on an on-line voting system that will allow Indian Seafarers to choose and vote for the Training Institute of their choice",
      },
      {
  ...
  placements: {
    ...
    DATA: [
      {
        BATCH_NAME: "B.Tech Placements Batch No – 9",
  ...
  principal_desk: {
    ...
    SUB_HEADING: "Principal – Euro Tech Maritime Academy",
    CONTENT_1:
  ...
  footer: {
    ...
    COPYRIGHT: "Copyright © 2022, EURO TECH, All Rights Reserved.",
  ...
  generic: {
    ...
    PHONE: "+91 7025080044",
    ADDRESS:
      "Euro Tech Maritime Academy Opp. TVS, Deshabhimani Jn Kaloor, Kochi, – 682017 Kerala, India",
    ADDRESS_TELEPHONE:
  ...
  faculty: {
    ...
    ABOUT_PRINCIPAL_CONTENT:
      "<p>They say half the world would freeze and other half would starve if there was no shipping, that’s how significant the shipping industry is to this world and mankind.goods are moved across the oceans from almost every nook and corner of this world meeting the expectations of the various basic and other needs of the humans.there are thousands and ten thousands of various types of ships trading across the the mighty oceans ,the coasts and inland waters . </p><br/><p>Ships need people to move them, they say there are about 1.25milion seafarers who do that job 24/7, moving the ships from one port to another, seafarers of all grades and rank.considering the nature of the job onboard ships, the seafarers needs to be trained to operate the various machineries and for the various operations onboard ships to ensure a safe and smooth timely operation.IMO has developed various training program’s and with the help of various Flag states promotes and encourages people from various nations to take up a career at sea.</p>",
  },
};
